...
con esto se instalaran todas las librerias necesarias para el funcionamiento de la app.

Luego de tener todas las librerias instaladas, deberemos installar rabbitmqServer, para esto vamos a la pagina oficial y seguimos los pasos.
